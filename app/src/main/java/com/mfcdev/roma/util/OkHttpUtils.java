 ...
 *
 * This file is part of Roma.
 *
 * Roma is free software: you can redistribute it and/or modify it under the terms of the GNU
 ...
 *
 * You should have received a copy of the GNU Lesser General Public License along with Roma. If
 * not, see <http://www.gnu.org/licenses/>. */

package com.mfcdev.roma.util;
...
public class OkHttpUtils {
    ...
    /**
     * Add a custom User-Agent that contains Roma & Android Version to all requests
     * Example:
     * User-Agent: Roma/1.1.2 Android/5.0.2
     */
    @NonNull
    private static Interceptor getUserAgentInterceptor() {
        return chain -> {
            ...
            Request requestWithUserAgent = originalRequest.newBuilder()
                    .header("User-Agent", "Roma/"+ BuildConfig.VERSION_NAME+" Android/"+Build.VERSION.RELEASE)
                    .build();
