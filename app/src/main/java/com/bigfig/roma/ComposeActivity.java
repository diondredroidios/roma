...
import com.bigfig.roma.adapter.EmojiAdapter;
import com.bigfig.roma.adapter.MentionAutoCompleteAdapter;
import com.bigfig.roma.adapter.OnEmojiSelectedListener;
import com.bigfig.roma.db.AccountEntity;
import com.bigfig.roma.db.AppDatabase;
import com.bigfig.roma.db.InstanceEntity;
import com.bigfig.roma.di.Injectable;
...
import com.bigfig.roma.network.ProgressRequestBody;
import com.bigfig.roma.service.SendTootService;
import com.bigfig.roma.util.CountUpDownLatch;
import com.bigfig.roma.util.DownsizeImageTask;
import com.bigfig.roma.util.ListUtils;
import com.bigfig.roma.util.MentionTokenizer;
import com.bigfig.roma.util.SaveTootHelper;
import com.bigfig.roma.util.SpanUtilsKt;
import com.bigfig.roma.util.StringUtils;
import com.bigfig.roma.util.ThemeUtils;
import com.bigfig.roma.view.ComposeOptionsListener;
import com.bigfig.roma.view.ComposeOptionsView;
import com.bigfig.roma.view.EditTextTyped;
import com.bigfig.roma.view.ProgressImageView;
import com.bigfig.roma.view.TootButton;
...
import static com.bigfig.roma.util.MediaUtilsKt.MEDIA_SIZE_UNKNOWN;
import static com.bigfig.roma.util.MediaUtilsKt.getImageSquarePixels;
import static com.bigfig.roma.util.MediaUtilsKt.getImageThumbnail;
import static com.bigfig.roma.util.MediaUtilsKt.getMediaSize;
import static com.bigfig.roma.util.MediaUtilsKt.getSampledBitmap;
import static com.bigfig.roma.util.MediaUtilsKt.getVideoThumbnail;
...
public final class ComposeActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (theme.equals("black")) {
            setTheme(R.style.RomaDialogActivityBlackTheme);
        }
    ...
    private File createNewImageFile() throws IOException {
        ...
        String imageFileName = "Roma_" + randomId + "_";
